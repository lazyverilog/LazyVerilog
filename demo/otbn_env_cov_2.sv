...
`define DEF_CSR(CSR_NAME, STR) \
  csr_str_t CSR_NAME = csr_str_t'(STR) `DEF_CSR(csr_load_checksum, "load_checksum"); `DEF_CSR(csr_ctrl, "ctrl");
    `undef DEF_CSR
...
`define DEF_MNEM_CROSS(BASENAME)                                         \
    BASENAME``_cross: cross mnemonic_cp, BASENAME``_cp;`define DEF_MNEM_CROSS2(BASE0, BASE1)                                    \
    BASE0``_``BASE1``_cross: cross mnemonic_cp, BASE0``_cp, BASE1``_cp;`define DEF_MNEM_CROSS3(BASE0, BASE1, BASE2)                             \
...
`define _DEF_TOGGLE_COV_1(BASE, BITS, IDXW, BIN_IDX)        \
  BASE``_``BIN_IDX``_cp: coverpoint BITS[IDXW 'b BIN_IDX];`define _DEF_TOGGLE_COV_2(BASE, BITS, IDXW, BIN_IDX)        \
  `_DEF_TOGGLE_COV_1(BASE, BITS, IDXW, BIN_IDX``0)          \
  `_DEF_TOGGLE_COV_1(BASE, BITS, IDXW, BIN_IDX``1)`define _DEF_TOGGLE_COV_4(BASE, BITS, IDXW, BIN_IDX)        \
  `_DEF_TOGGLE_COV_2(BASE, BITS, IDXW, BIN_IDX``0)          \
  `_DEF_TOGGLE_COV_2(BASE, BITS, IDXW, BIN_IDX``1)`define _DEF_TOGGLE_COV_8(BASE, BITS, IDXW, BIN_IDX)        \
  `_DEF_TOGGLE_COV_4(BASE, BITS, IDXW, BIN_IDX``0)          \
  `_DEF_TOGGLE_COV_4(BASE, BITS, IDXW, BIN_IDX``1)`define _DEF_TOGGLE_COV_16(BASE, BITS, IDXW, BIN_IDX)       \
  `_DEF_TOGGLE_COV_8(BASE, BITS, IDXW, BIN_IDX``0)          \
  `_DEF_TOGGLE_COV_8(BASE, BITS, IDXW, BIN_IDX``1)`define _DEF_TOGGLE_COV_32(BASE, BITS, IDXW, BIN_IDX)       \
  `_DEF_TOGGLE_COV_16(BASE, BITS, IDXW, BIN_IDX``0)         \
  `_DEF_TOGGLE_COV_16(BASE, BITS, IDXW, BIN_IDX``1)`define _DEF_TOGGLE_COV_64(BASE, BITS, IDXW, BIN_IDX)       \
  `_DEF_TOGGLE_COV_32(BASE, BITS, IDXW, BIN_IDX``0)         \
  `_DEF_TOGGLE_COV_32(BASE, BITS, IDXW, BIN_IDX``1)`define _DEF_TOGGLE_COV_128(BASE, BITS, IDXW, BIN_IDX)      \
...
`define DEF_GPR_TOGGLE_COV(BASE, BITS)                      \
  ...
  `_DEF_TOGGLE_COV_16(BASE, BITS, 5, 1)`define DEF_WDR_TOGGLE_COV(BASE, BITS)                      \
  `_DEF_TOGGLE_COV_128(BASE, BITS, 8, 0)                    \
  `_DEF_TOGGLE_COV_128(BASE, BITS, 8, 1)`define DEF_FLAGS_TOGGLE_COV(BASE, BITS)                    \
  `_DEF_TOGGLE_COV_2(BASE, BITS, 2, 0)                      \
  `_DEF_TOGGLE_COV_2(BASE, BITS, 2, 1)`define DEF_MLZ_FLAGS_TOGGLE_COV(BASE, BITS)                \
...
`define _DEF_TOGGLE_CROSS_1(BASE, BIN_IDX)                              \
  BASE``_``BIN_IDX``_cross: cross mnemonic_cp, BASE``_``BIN_IDX``_cp;`define _DEF_TOGGLE_CROSS_2(BASE, BIN_IDX)                              \
  `_DEF_TOGGLE_CROSS_1(BASE, BIN_IDX``0)                                \
  `_DEF_TOGGLE_CROSS_1(BASE, BIN_IDX``1)`define _DEF_TOGGLE_CROSS_4(BASE, BIN_IDX)                              \
  `_DEF_TOGGLE_CROSS_2(BASE, BIN_IDX``0)                                \
  `_DEF_TOGGLE_CROSS_2(BASE, BIN_IDX``1)`define _DEF_TOGGLE_CROSS_8(BASE, BIN_IDX)                              \
  `_DEF_TOGGLE_CROSS_4(BASE, BIN_IDX``0)                                \
  `_DEF_TOGGLE_CROSS_4(BASE, BIN_IDX``1)`define _DEF_TOGGLE_CROSS_16(BASE, BIN_IDX)                             \
  `_DEF_TOGGLE_CROSS_8(BASE, BIN_IDX``0)                                \
  `_DEF_TOGGLE_CROSS_8(BASE, BIN_IDX``1)`define _DEF_TOGGLE_CROSS_32(BASE, BIN_IDX)                             \
  `_DEF_TOGGLE_CROSS_16(BASE, BIN_IDX``0)                               \
  `_DEF_TOGGLE_CROSS_16(BASE, BIN_IDX``1)`define _DEF_TOGGLE_CROSS_64(BASE, BIN_IDX)                             \
  `_DEF_TOGGLE_CROSS_32(BASE, BIN_IDX``0)                               \
  `_DEF_TOGGLE_CROSS_32(BASE, BIN_IDX``1)`define _DEF_TOGGLE_CROSS_128(BASE, BIN_IDX)                            \
...
`define DEF_GPR_TOGGLE_CROSS(BASE)                                      \
  ...
  `_DEF_TOGGLE_CROSS_16(BASE, 1)`define DEF_WDR_TOGGLE_CROSS(BASE)                                      \
  `_DEF_TOGGLE_CROSS_128(BASE, 0)                                       \
  `_DEF_TOGGLE_CROSS_128(BASE, 1)`define DEF_FLAGS_TOGGLE_CROSS(BASE)                                    \
  `_DEF_TOGGLE_CROSS_2(BASE, 0)                                         \
  `_DEF_TOGGLE_CROSS_2(BASE, 1)`define DEF_MLZ_FLAGS_TOGGLE_CROSS(BASE)                                \
  ...
  NAME: coverpoint (remap_wsr(EXPR)) { \
    ...
    endgroup
        ...
        endgroup
            ...
            // CMD external CSR
            covergroup ext_csr_cmd_cg with function sample(otbn_pkg::cmd_e value, access_e access_type, operational_state_e state);
                ...
                {bins CmdExecute = {otbn_pkg::CmdExecute};
                    ...
                    bins BogusCmd = {[0:$]} with (!(item inside {otbn_pkg::CmdExecute, otbn_pkg::CmdSecWipeDmem, otbn_pkg::CmdSecWipeImem}));
            ...
            endgroup
                ...
                // CTRL external CSR
                covergroup ext_csr_ctrl_cg with function sample(logic value, access_e access_type, operational_state_e state);
                        // See a read as well as a write.
                    access_type_cp: coverpoint access_type;

                        // See a write of each value in idle state.
                    value_cp: coverpoint value iff ((access_type==AccessSoftwareWrite)&&(state==OperationalStateIdle));
                endgroup

                    // STATUS external CSR
                    covergroup ext_csr_status_cg with function sample(otbn_pkg::status_e value, access_e access_type);
                    ...
                    endgroup
                        ...
                        covergroup ext_csr_err_bits_cg with function sample(otbn_pkg::err_bits_t value, logic [31:0] old_value, access_e access_type, operational_state_e state);
...
`define DEF_ERR_BIT_CP(NAME) \
  `DEF_SEEN_IF_CP(err_bits_``NAME``_cp, value.NAME, access_type == AccessSoftwareRead)
                        ...
                        endgroup
                            ...
                            covergroup ext_csr_fatal_alert_cause_cg with function sample(logic [31:0] value, access_e access_type, operational_state_e state);
...
`define DEF_FAC_CP(NAME, IDX) \
  `DEF_SEEN_IF_CP(fatal_alert_cause_``NAME``_cp, value[IDX], access_type == AccessSoftwareRead)
                            ...
                            endgroup
                                ...
                                covergroup ext_csr_insn_cnt_cg with function sample(logic [31:0] value, logic [31:0] old_value, access_e access_type, operational_state_e state);
                                ...
                                endgroup
                                    ...
                                    endgroup
                                        ...
                                        covergroup ext_csr_wr_operational_state_cg with function sample(csr_str_t csr, operational_state_e wr_state);
                                        ...
                                        endgroup
                                            ...
                                            covergroup promoted_err_cg with function sample(logic [5:0] last_err_bits);
                                            ...
                                            endgroup
                                                ...
                                                endgroup
                                                    ...
                                                    covergroup call_stack_cg with function sample(call_stack_flags_t flags, stack_fullness_e fullness);
                                                    ...
                                                    endgroup
                                                        ...
                                                        covergroup flag_write_cg with function sample(bit flag_group, flags_t read_data, flags_t write_data);
                                                        ...
                                                        endgroup
                                                            ...
                                                            covergroup bad_internal_state_cg with function sample(logic urnd_all_zero, logic insn_addr_err, logic scramble_state_err, otbn_pkg::predec_err_t predec_err, otbn_pkg::missed_gnt_t missed_gnt, otbn_pkg::controller_bad_int_t controller_bad_int, otbn_pkg::start_stop_bad_int_t start_stop_bad_int, logic rf_base_spurious_we_err, logic rf_bignum_spurious_we_err);
                                                            ...
                                                            endgroup
                                                                ...
                                                                endgroup
                                                                    ...
                                                                    covergroup insn_addr_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_addr);
                                                                            `DEF_SEEN_CP(str_insn_at_top_cp, (insn_addr==ImemSizeByte-4)&& !(mnemonic inside {mnem_beq, mnem_bne, mnem_jal, mnem_jalr, mnem_ecall, mnem_loop, mnem_loopi}))
                                                                    ...
                                                                    endgroup
                                                                        ...
                                                                        covergroup pairwise_insn_cg with function sample(mnem_str_t last, mnem_str_t cur);
                                                                            ...
                                                                            cur_cp: coverpoint cur {
                                                                                    `DEF_MNEM_BINS_EXCEPT_ECALL `DEF_MNEM_BIN(mnem_ecall);
                                                                        ...
                                                                        endgroup
                                                                            ...
                                                                            covergroup enc_bna_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b, flags_t flags_write_data[2], logic [255:0] wdr_write_data);
                                                                                ...
                                                                                mnemonic_cp: coverpoint mnemonic {
                                                                                    ...
                                                                                    `DEF_SEEN_CP
                                                                                (nz_shifted_cp, 0!=(insn_data[30]?(wdr_operand_b>>{insn_data[29:25], 3'b0}):(wdr_operand_b<<{insn_data[29:25], 3'b0})))

                                                                                sb_cp: coverpoint insn_data[29:25] {
                                                                                        bins extremes[] = {'0, '1};
                                                                                    }
                                                                            ...
                                                                            endgroup
                                                                                ...
                                                                                covergroup enc_bnaf_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b, flags_t flags_write_data[2]);
                                                                                    ...
                                                                                    nz_shifted
                                                                                        ...
                                                                                        `DEF_SEEN_CP(srl_cp, (insn_data[29:25]!=0)&&insn_data[30]&&wdr_operand_b[255])
                                                                                        `DEF_MNEM_CROSS(srl)
                                                                                endgroup

                                                                                    covergroup enc_bnai_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, flags_t flags_write_data[2]);
                                                                                        ...
                                                                                        imm_cp: coverpoint insn_data[29:20] {
                                                                                                bins extremes[] = {'0, '1};
                                                                                            }
                                                                                        fg_cp: coverpoint insn_data[31];
                                                                                            `DEF_MNEM_CROSS(imm)
                                                                                    ...
                                                                                    endgroup
                                                                                        ...
                                                                                        covergroup enc_bnam_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b);
                                                                                        ...
                                                                                        endgroup
                                                                                            ...
                                                                                            covergroup enc_bnan_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, flags_t flags_write_data[2], logic [255:0] wdr_write_data);
                                                                                                ...
                                                                                                mnemonic_cp: coverpoint mnemonic {
                                                                                                    ...
                                                                                                    `DEF_SEEN_CP
                                                                                                (nz_shifted_cp, 0!=(insn_data[30]?(wdr_operand_a>>{insn_data[29:25], 3'b0}):(wdr_operand_a<<{insn_data[29:25], 3'b0})))
                                                                                            ...
                                                                                            endgroup
                                                                                                ...
                                                                                                covergroup enc_bnaq_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b);
                                                                                                    ...
                                                                                                    shift_cp: coverpoint insn_data[14:13] {
                                                                                                            bins extremes[] = {'0, '1};
                                                                                                        }
                                                                                                    q1_cp: coverpoint insn_data[26:25] {
                                                                                                            bins extremes[] = {'0, '1};
                                                                                                        }
                                                                                                    q2_cp: coverpoint insn_data[28:27] {
                                                                                                            bins extremes[] = {'0, '1};
                                                                                                        }
                                                                                                ...
                                                                                                endgroup
                                                                                                    ...
                                                                                                    covergroup enc_bnaqs_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b, flags_t flags_write_data[2]);
                                                                                                    ...
                                                                                                    endgroup
                                                                                                        ...
                                                                                                        covergroup enc_bnaqw_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b, flags_t flags_write_data[2]);
                                                                                                        ...
                                                                                                        endgroup
                                                                                                            ...
                                                                                                            covergroup enc_bnc_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b, flags_t flags_write_data[2]);
                                                                                                            ...
                                                                                                            endgroup
                                                                                                                ...
                                                                                                                covergroup enc_bnmov_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a);
                                                                                                                ...
                                                                                                                endgroup
                                                                                                                    ...
                                                                                                                    covergroup enc_bnmovr_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [31:0] gpr_operand_a, logic [31:0] gpr_operand_b);
                                                                                                                    ...
                                                                                                                    endgroup
                                                                                                                        ...
                                                                                                                        covergroup enc_bnr_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b);
                                                                                                                        ...
                                                                                                                        endgroup
                                                                                                                            ...
                                                                                                                            covergroup enc_bns_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b, flags_t flags_read_data[2]);
                                                                                                                            ...
                                                                                                                            endgroup
                                                                                                                                ...
                                                                                                                                covergroup enc_bnxid_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [31:0] gpr_operand_a, logic [31:0] gpr_operand_b);
                                                                                                                                    ...
                                                                                                                                    off_cp: coverpoint {
                                                                                                                                            insn_data[31:25], insn_data[11:9]
                                                                                                                                        }
                                                                                                                                    {bins extremes[] = {'0, '1};
                                                                                                                                    }
                                                                                                                                ...
                                                                                                                                endgroup
                                                                                                                                    ...
                                                                                                                                    covergroup enc_b_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [31:0] gpr_operand_a, logic [31:0] gpr_operand_b);
                                                                                                                                    ...
                                                                                                                                    endgroup
                                                                                                                                        ...
                                                                                                                                        endgroup
                                                                                                                                            ...
                                                                                                                                            covergroup enc_i_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [31:0] gpr_operand_a);
                                                                                                                                                ...
                                                                                                                                                imm_cp: coverpoint insn_data[31:20] {
                                                                                                                                                        bins extremes[] = {12'h800, 12'h7ff};
                                                                                                                                                    }
                                                                                                                                                    `DEF_MNEM_CROSS
                                                                                                                                                (imm)
                                                                                                                                            ...
                                                                                                                                            endgroup
                                                                                                                                                ...
                                                                                                                                                covergroup enc_is_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [31:0] gpr_operand_a);
                                                                                                                                                    ...
                                                                                                                                                    shamt_cp: coverpoint insn_data[24:20] {
                                                                                                                                                            bins extremes[] = {'0, '1};
                                                                                                                                                        }
                                                                                                                                                        `DEF_MNEM_CROSS
                                                                                                                                                    (shamt)
                                                                                                                                                ...
                                                                                                                                                endgroup
                                                                                                                                                    ...
                                                                                                                                                    covergroup enc_j_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data);
                                                                                                                                                        ...
                                                                                                                                                        off_cp: coverpoint insn_data[31:12] {
                                                                                                                                                                bins extremes[] = {20'h80000, 20'h7ffff};
                                                                                                                                                            }
                                                                                                                                                    ...
                                                                                                                                                    endgroup
                                                                                                                                                        ...
                                                                                                                                                        covergroup enc_loop_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [31:0] gpr_operand_a);
                                                                                                                                                            ...
                                                                                                                                                            sz_cp: coverpoint insn_data[31:20] {
                                                                                                                                                                    bins extremes[] = {'0, '1};
                                                                                                                                                                }
                                                                                                                                                        ...
                                                                                                                                                        endgroup
                                                                                                                                                            ...
                                                                                                                                                            covergroup enc_loopi_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data);
                                                                                                                                                                ...
                                                                                                                                                                iterations_cp: coverpoint {
                                                                                                                                                                        insn_data[19:15], insn_data[11:7]
                                                                                                                                                                    }
                                                                                                                                                                {bins extremes[] = {'0, '1};
                                                                                                                                                                }
                                                                                                                                                            endgroup

                                                                                                                                                                covergroup enc_r_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [31:0] gpr_operand_a, logic [31:0] gpr_operand_b);
                                                                                                                                                                ...
                                                                                                                                                                endgroup
                                                                                                                                                                    ...
                                                                                                                                                                    covergroup enc_s_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [31:0] gpr_operand_a, logic [31:0] gpr_operand_b);
                                                                                                                                                                        ...
                                                                                                                                                                        off_cp: coverpoint {
                                                                                                                                                                                insn_data[31:25], insn_data[11:7]
                                                                                                                                                                            }
                                                                                                                                                                        {bins extremes[] = {12'h800, 12'h7ff};
                                                                                                                                                                        }
                                                                                                                                                                    ...
                                                                                                                                                                    endgroup
                                                                                                                                                                        ...
                                                                                                                                                                        covergroup enc_u_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data);
                                                                                                                                                                            ...
                                                                                                                                                                            imm_cp: coverpoint insn_data[31:12] {
                                                                                                                                                                                    bins extremes[] = {'0, '1};
                                                                                                                                                                                }
                                                                                                                                                                        ...
                                                                                                                                                                        endgroup
                                                                                                                                                                            ...
                                                                                                                                                                            covergroup enc_wcsr_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data);
                                                                                                                                                                                ...
                                                                                                                                                                                wsr_imm_cp: coverpoint insn_data[27:20] {
                                                                                                                                                                                        bins extremes[] = {'0, '1};
                                                                                                                                                                                    }
                                                                                                                                                                                    `DEF_MNEM_CROSS
                                                                                                                                                                                (wsr_imm)
                                                                                                                                                                            ...
                                                                                                                                                                            endgroup
                                                                                                                                                                                ...
                                                                                                                                                                                covergroup enc_bnva_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b);
                                                                                                                                                                                    mnemonic_cp: coverpoint mnemonic {
                                                                                                                                                                                ...
                                                                                                                                                                                endgroup
                                                                                                                                                                                    ...
                                                                                                                                                                                    covergroup enc_bnvm_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b);
                                                                                                                                                                                        mnemonic_cp: coverpoint mnemonic {
                                                                                                                                                                                    ...
                                                                                                                                                                                    endgroup
                                                                                                                                                                                        ...
                                                                                                                                                                                        covergroup enc_bnvtrn_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b);
                                                                                                                                                                                            mnemonic_cp: coverpoint mnemonic {
                                                                                                                                                                                        ...
                                                                                                                                                                                        endgroup
                                                                                                                                                                                            ...
                                                                                                                                                                                            covergroup enc_bnvsh_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_b, logic [7:0] nonzero_shift_results);
                                                                                                                                                                                                mnemonic_cp: coverpoint mnemonic {
                                                                                                                                                                                                        `DEF_MNEM_BIN(mnem_bn_shv);
                                                                                                                                                                                                        illegal_bins other = default;
                                                                                                                                                                                                    }
                                                                                                                                                                                            ...
                                                                                                                                                                                            endgroup
                                                                                                                                                                                                ...
                                                                                                                                                                                                covergroup enc_bnpk_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b);
                                                                                                                                                                                                    mnemonic_cp: coverpoint mnemonic {
                                                                                                                                                                                                ...
                                                                                                                                                                                                endgroup
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    covergroup insn_addsub_cg with function sample(mnem_str_t mnemonic, logic [31:0] operand_a, logic [31:0] operand_b);
                                                                                                                                                                                                        mnemonic_cp: coverpoint mnemonic {
                                                                                                                                                                                                                `DEF_MNEM_BIN(mnem_add);
                                                                                                                                                                                                                `DEF_MNEM_BIN(mnem_sub);
                                                                                                                                                                                                                illegal_bins other = default;
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    endgroup
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        covergroup insn_addi_cg with function sample(logic [31:0] insn_data, logic [31:0] operand_a);
                                                                                                                                                                                                                `DEF_SIGN_CP(
                                                                                                                                                                                                            sign_a_cp,
                                                                                                                                                                                                            operand_a,
                                                                                                                                                                                                            32
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        endgroup
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            covergroup insn_sll_cg with function sample(logic [31:0] operand_a, logic [31:0] operand_b);
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    // nonzero)
                                                                                                                                                                                                                    `DEF_SEEN_CP(shift15_cp, operand_a[0]&&((operand_b&'h1 f)=='h1 f))
                                                                                                                                                                                                            endgroup

                                                                                                                                                                                                                covergroup insn_slli_cg with function sample(logic [31:0] insn_data, logic [31:0] operand_a);
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                endgroup
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    covergroup insn_srl_cg with function sample(logic [31:0] operand_a, logic [31:0] operand_b);

                                                                                                                                                                                                                            // A shift of a nonzero value by zero
                                                                                                                                                                                                                            `DEF_SEEN_CP(nz_by_z_cp, (operand_a!=0)&&(operand_b==0))
                                                                                                                                                                                                                            // A shift of a value by 0x1f, leaving the bottom bit set (because the top bit of the value was
                                                                                                                                                                                                                            // nonzero)
                                                                                                                                                                                                                            `DEF_SEEN_CP(shift15_cp, operand_a[31]&&((operand_b&'h1 f)=='h1 f))
                                                                                                                                                                                                                    endgroup

                                                                                                                                                                                                                        covergroup insn_srli_cg with function sample(logic [31:0] insn_data, logic [31:0] operand_a);
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        endgroup
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            covergroup insn_sra_cg with function sample(logic [31:0] operand_a, logic [31:0] operand_b);
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            endgroup
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                covergroup insn_srai_cg with function sample(logic [31:0] insn_data, logic [31:0] operand_a);
                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                endgroup
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    covergroup insn_log_binop_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, logic [31:0] gpr_write_data);
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        x0_cp: coverpoint insn_data[11:7] {
                                                                                                                                                                                                                                                illegal_bins x0 = {0};
                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    endgroup
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        covergroup insn_xw_cg with function sample(mnem_str_t mnemonic, logic [11:0] offset, logic [4:0] grs1, logic [4:0] grx2, logic [31:0] operand_a, logic signed [31:0] addr, stack_fullness_e call_stack_fullness, logic call_stack_underflow);
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            mnemonic_cp: coverpoint mnemonic {
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                `DEF_SEEN_CP
                                                                                                                                                                                                                                            (oob_base_neg_off_cp, ($signed(operand_a)>DmemSizeByte)&&($signed(offset)<0)&&(0<=addr)&&(addr+4<=DmemSizeByte)&&((addr&32'h3)==0))
                                                                                                                                                                                                                                                `DEF_MNEM_CROSS(oob_base_neg_off)

                                                                                                                                                                                                                                                // Load from a valid address, where grs1 is negative and a positive offset brings the load
                                                                                                                                                                                                                                                // address in range.
                                                                                                                                                                                                                                                `DEF_SEEN_CP(neg_base_pos_off_cp, ($signed(operand_a)<0)&&($signed(offset)>0)&&(0<=addr)&&(addr+4<=DmemSizeByte)&&((addr&32'h3)==0))
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            align_cross: cross mnemonic_cp, grs1_align_cp, offset_align_cp iff ((0<=addr)&&(addr+4<=DmemSizeByte));
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                `DEF_SEEN_CP(overflow_cs_invalid_addr_cp, (call_stack_fullness==StackFull)&&(grx2==1)&&(addr<0||(addr+4>DmemSizeByte)||(addr&32'h3)!=0))
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                `DEF_SEEN_CP(underflow_cs_invalid_addr_cp, mnemonic==mnem_sw&&call_stack_underflow&&grs1!=5'd1&&(addr<0||(addr+4>DmemSizeByte)||(addr&32'h3)!=0))
                                                                                                                                                                                                                                        endgroup

                                                                                                                                                                                                                                            covergroup insn_bxx_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_addr, logic [12:0] offset, logic [31:0] operand_a, logic [31:0] operand_b, logic signed [31:0] tgt_addr, logic at_current_loop_end_insn, logic call_stack_underflow);
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                at_loop_end_cp: coverpoint at_current_loop_end_insn;
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    `DEF_SEEN_CP(bad_addr_at_loop_end_cp, at_current_loop_end_insn&&((mnemonic==mnem_beq)?(operand_a==operand_b):(operand_a!=operand_b))&&(tgt_addr<0||tgt_addr>ImemSizeByte||tgt_addr[1:0]!=0))
                                                                                                                                                                                                                                                    `DEF_MNEM_CROSS(bad_addr_at_loop_end)
                                                                                                                                                                                                                                            endgroup

                                                                                                                                                                                                                                                covergroup insn_jal_cg with function sample(logic [31:0] insn_addr, logic [20:0] offset, logic signed [31:0] tgt_addr, logic at_current_loop_end_insn, logic call_stack_overflow);
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    at_loop_end_cp: coverpoint at_current_loop_end_insn;
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        `DEF_SEEN_CP(overflow_and_invalid_addr_cp, call_stack_overflow&&(tgt_addr<0||tgt_addr>ImemSizeByte||tgt_addr[1:0]!=0))
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        `DEF_SEEN_CP(invalid_addr_at_loop_end_cp, (tgt_addr<0||tgt_addr>ImemSizeByte||tgt_addr[1:0]!=0)&&at_current_loop_end_insn)

                                                                                                                                                                                                                                                        // Overflow the call stack while jumping to an invalid address at the end of a loop
                                                                                                                                                                                                                                                        `DEF_SEEN_CP(overflow_and_invalid_addr_at_loop_end_cp, call_stack_overflow&&(tgt_addr<0||tgt_addr>ImemSizeByte||tgt_addr[1:0]!=0)&&at_current_loop_end_insn)
                                                                                                                                                                                                                                                endgroup

                                                                                                                                                                                                                                                    covergroup insn_jalr_cg with function sample(logic [31:0] insn_addr, logic [11:0] offset, logic signed [31:0] tgt_addr, logic [31:0] operand_a, logic at_current_loop_end_insn, logic call_stack_underflow, logic call_stack_overflow);
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        align_cross: cross offset_align_cp, base_align_cp;
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            `DEF_SEEN_CP(pos_wrap_cp, (operand_a>=ImemSizeByte)&&($signed(offset)>0)&&(tgt_addr<=ImemSizeByte-4))

                                                                                                                                                                                                                                                            // Jump with a base address just above top of IMEM but with a negative offset to give a valid
                                                                                                                                                                                                                                                            // target.
                                                                                                                                                                                                                                                            `DEF_SEEN_CP(sub_cp, (operand_a>=ImemSizeByte)&&($signed(offset)<0)&&(tgt_addr<=ImemSizeByte-4))

                                                                                                                                                                                                                                                            // Jump with a negative offset, wrapping to give an invalid target.
                                                                                                                                                                                                                                                            `DEF_SEEN_CP(neg_wrap_cp, (operand_a<=ImemSizeByte-4)&&($signed(offset)<0)&&(tgt_addr>ImemSizeByte-4))
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        at_loop_end_cp: coverpoint at_current_loop_end_insn;
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            `DEF_SEEN_CP(overflow_and_bad_addr_cp, call_stack_overflow&&(tgt_addr<0||tgt_addr>=ImemSizeByte||tgt_addr[1:0]!=0))

                                                                                                                                                                                                                                                            // Overflow call stack at end of loop
                                                                                                                                                                                                                                                            `DEF_SEEN_CP(overflow_at_loop_end_cp, call_stack_overflow&&at_current_loop_end_insn)

                                                                                                                                                                                                                                                            // Jump to an invalid address at the end of a loop
                                                                                                                                                                                                                                                            `DEF_SEEN_CP(bad_addr_at_loop_end_cp, (tgt_addr<0||tgt_addr>=ImemSizeByte||tgt_addr[1:0]!=0)&&at_current_loop_end_insn)

                                                                                                                                                                                                                                                            // Overflow call stack when jumping to an invalid address at the end of a loop
                                                                                                                                                                                                                                                            `DEF_SEEN_CP(overflow_and_bad_addr_at_loop_end_cp, call_stack_overflow&&(tgt_addr<0||tgt_addr>=ImemSizeByte||tgt_addr[1:0]!=0)&&at_current_loop_end_insn)
                                                                                                                                                                                                                                                    endgroup

                                                                                                                                                                                                                                                        covergroup insn_csrrs_cg with function sample(logic [31:0] insn_data, logic [31:0] operand_a, stack_fullness_e call_stack_fullness);
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            csr_cross: cross csr_cp, bits_to_set_cp;
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                `DEF_SEEN_CP(underflow_with_bad_csr_cp, (call_stack_fullness==StackEmpty)&&(insn_data[19:15]==5'd1)&&(remap_csr(insn_data[31:20])==-1))

                                                                                                                                                                                                                                                                // Overflow the call stack while accessing an invalid CSR. The RTL squashes the GPR reads in
                                                                                                                                                                                                                                                                // this case, so we have to figure out a call stack underflow by hand (true if the call stack
                                                                                                                                                                                                                                                                // was full and grd is x1)
                                                                                                                                                                                                                                                                `DEF_SEEN_CP(overflow_with_bad_csr_cp, (call_stack_fullness==StackFull)&&(insn_data[11:7]==5'd1)&&(remap_csr(insn_data[31:20])==-1))
                                                                                                                                                                                                                                                        endgroup

                                                                                                                                                                                                                                                            covergroup insn_csrrw_cg with function sample(logic [31:0] insn_data, stack_fullness_e call_stack_fullness);
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            endgroup
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                covergroup insn_loop_cg with function sample(logic [31:0] insn_addr, logic [31:0] insn_data, logic [31:0] operand_a, stack_fullness_e loop_stack_fullness, logic [31:0] current_loop_end, logic [31:0] bodysize, logic at_loop_end, logic call_stack_underflow);
                                                                                                                                                                                                                                                                        // Extremes for iteration count
                                                                                                                                                                                                                                                                    iterations_cp: coverpoint operand_a {
                                                                                                                                                                                                                                                                            bins extremes[] = {'0, '1};
                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    at_loop_end_cp: coverpoint at_loop_end;
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        `DEF_SEEN_CP(duplicate_loop_end_cp, (loop_stack_fullness!=StackEmpty)&&(current_loop_end==insn_addr+4*bodysize))
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                endgroup
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    covergroup insn_loopi_cg with function sample(logic [31:0] insn_addr, logic [31:0] insn_data, stack_fullness_e loop_stack_fullness, logic [31:0] current_loop_end, logic [9:0] iterations, logic [31:0] bodysize, logic at_loop_end);
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    endgroup
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        covergroup insn_bn_addc_cg with function sample(logic [31:0] insn_data, flags_t flags_read_data[2]);
                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                        endgroup
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            covergroup insn_bn_addm_cg with function sample(logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b, logic [255:0] mod);

                                                                                                                                                                                                                                                                                    // Extreme values of MOD
                                                                                                                                                                                                                                                                                mod_cp: coverpoint mod {
                                                                                                                                                                                                                                                                                        bins extremes[] = {'0, '1};
                                                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP
                                                                                                                                                                                                                                                                                (sum_lt_cp, (mod!=0)&&({1'b0, wdr_operand_a}+{1'b0, wdr_operand_b}<{1'b0, mod}))

                                                                                                                                                                                                                                                                                    // Sum exactly equals a nonzero MOD (subtracting down to zero)
                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(sum_eq_cp, (mod!=0)&&({1'b0, wdr_operand_a}+{1'b0, wdr_operand_b}=={1'b0, mod}))

                                                                                                                                                                                                                                                                                    // Sum is greater than a nonzero MOD, but not twice as big.
                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(sum_gt_cp, (mod!=0)&&({1'b0, wdr_operand_a}+{1'b0, wdr_operand_b}>{1'b0, mod})&&({1'b0, wdr_operand_a}+{1'b0, wdr_operand_b}<{mod, 1'b0}))

                                                                                                                                                                                                                                                                                    // Sum is at least twice a nonzero MOD.
                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(sum_gt2_cp, (mod!=0)&&({1'b0, wdr_operand_a}+{1'b0, wdr_operand_b}>={mod, 1'b0}))

                                                                                                                                                                                                                                                                                    // The intermediate sum overflows 256 bits
                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(overflow_cp, (({1'b0, wdr_operand_a}+{1'b0, wdr_operand_b})>>256)!=0)

                                                                                                                                                                                                                                                                                    // Wrap after subtraction?
                                                                                                                                                                                                                                                                                wrap_after_mod_cp: coverpoint ((({1'b0, wdr_operand_a}+{1'b0, wdr_operand_b}>{1'b0, mod})?({1'b0, wdr_operand_a}+{1'b0, wdr_operand_b}-{1'b0, mod}):({1'b0, wdr_operand_a}+{1'b0, wdr_operand_b}))>>256)!=0;

                                                                                                                                                                                                                                                                                overflow_wrap_cross: cross overflow_cp, wrap_after_mod_cp;
                                                                                                                                                                                                                                                                            endgroup

                                                                                                                                                                                                                                                                                covergroup insn_bn_mulqaccx_cg with function sample(mnem_str_t mnemonic, logic [256:0] new_acc_extended);
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    mnemonic_cp: coverpoint mnemonic {
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        `DEF_SEEN_CP
                                                                                                                                                                                                                                                                                    (overflow_cp, new_acc_extended[256])
                                                                                                                                                                                                                                                                                        `DEF_MNEM_CROSS(overflow)

                                                                                                                                                                                                                                                                                endgroup

                                                                                                                                                                                                                                                                                    covergroup insn_bn_subcmpb_cg with function sample(mnem_str_t mnemonic, logic [31:0] insn_data, flags_t flags_read_data[2]);
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    endgroup
                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                        covergroup insn_bn_subm_cg with function sample(logic [31:0] insn_data, logic [255:0] wdr_operand_a, logic [255:0] wdr_operand_b, logic [255:0] mod);
                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                            mod_cp: coverpoint mod {
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                `DEF_SEEN_CP
                                                                                                                                                                                                                                                                                            (diff_nonneg_cp, (mod!=0)&&({1'b0, wdr_operand_a}-{1'b0, wdr_operand_b}<{1'b1, 256'b0}))

                                                                                                                                                                                                                                                                                                // Difference exactly equals a nonzero -MOD (adding back up to zero)
                                                                                                                                                                                                                                                                                                `DEF_SEEN_CP(diff_minus_mod_cp, (mod!=0)&&({1'b0, wdr_operand_a}-{1'b0, wdr_operand_b}+{1'b0, mod}==0))

                                                                                                                                                                                                                                                                                                // Difference is between -MOD and -1.
                                                                                                                                                                                                                                                                                                `DEF_SEEN_CP(diff_neg_cp, (mod!=0)&&({1'b0, wdr_operand_a}-{1'b0, wdr_operand_b}>={1'b1, 256'b0})&&({1'b0, wdr_operand_a}-{1'b0, wdr_operand_b}+{1'b0, mod}<{1'b1, 256'b0}))

                                                                                                                                                                                                                                                                                                // Difference is less than -MOD
                                                                                                                                                                                                                                                                                                `DEF_SEEN_CP(diff_neg2_cp, (mod!=0)&&(mod!=0)&&({1'b0, wdr_operand_a}-{1'b0, wdr_operand_b}>={1'b1, 256'b0})&&({1'b0, wdr_operand_a}-{1'b0, wdr_operand_b}+{1'b0, mod}>={1'b1, 256'b0}))
                                                                                                                                                                                                                                                                                        endgroup

                                                                                                                                                                                                                                                                                            // Used by BN.LID and BN.SID
                                                                                                                                                                                                                                                                                            covergroup insn_bn_xid_cg with function sample(mnem_str_t mnemonic, logic [14:0] offset, logic [31:0] operand_a, logic [31:0] operand_b, logic signed [31:0] addr, logic inc_both, logic [4:0] grs1, logic [4:0] grx2, logic call_stack_underflow);
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                mnemonic_cp: coverpoint mnemonic {
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP
                                                                                                                                                                                                                                                                                                (oob_base_neg_off_cp, ($signed(operand_a)>DmemSizeByte)&&($signed(offset)<0)&&(0<=addr)&&(addr+32<=DmemSizeByte)&&((addr&32'd31)==0))
                                                                                                                                                                                                                                                                                                    `DEF_MNEM_CROSS(oob_base_neg_off)

                                                                                                                                                                                                                                                                                                    // Access a valid address, where grs1 is negative and a positive offset brings the address in
                                                                                                                                                                                                                                                                                                    // range.
                                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(neg_base_pos_off_cp, ($signed(operand_a)<0)&&($signed(offset)>0)&&(0<=addr)&&(addr+32<=DmemSizeByte)&&((addr&32'd31)==0))
                                                                                                                                                                                                                                                                                                    `DEF_MNEM_CROSS(neg_base_pos_off)
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(oob_addr_cp, (addr>DmemSizeByte-32)&&((addr&32'd31)==0))
                                                                                                                                                                                                                                                                                                    `DEF_MNEM_CROSS(oob_addr)
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                addr_align_cross: cross mnemonic_cp, addr_align_cp iff ((0<=addr)&&(addr+32<=DmemSizeByte));
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(underflow_and_badb_cp, call_stack_underflow&&(grx2!=5'd1)&&(operand_b>=32))
                                                                                                                                                                                                                                                                                                    `DEF_MNEM_CROSS(underflow_and_badb)

                                                                                                                                                                                                                                                                                                    // Underflow call stack with grd/grs2 and compute a bad address from *grs1
                                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(underflow_and_bad_addr_cp, call_stack_underflow&&(grs1!=5'd1)&&((0<addr)||(addr>=DmemSizeByte)||((addr&32'd31)!=0)))
                                                                                                                                                                                                                                                                                                    `DEF_MNEM_CROSS(underflow_and_bad_addr)

                                                                                                                                                                                                                                                                                                    // Set both increments and have a bad WDR index in *grd/*grs2.
                                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(inc_both_and_bad_wdr_cp, inc_both&& !call_stack_underflow&&(operand_b>=32))
                                                                                                                                                                                                                                                                                                    `DEF_MNEM_CROSS(inc_both_and_bad_wdr)

                                                                                                                                                                                                                                                                                                    // Set both increments and compute a bad address from *grs1
                                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(inc_both_and_bad_addr_cp, inc_both&& !call_stack_underflow&&((0<addr)||(addr>=DmemSizeByte)||((addr&32'd31)!=0)))
                                                                                                                                                                                                                                                                                                    `DEF_MNEM_CROSS(inc_both_and_bad_addr)

                                                                                                                                                                                                                                                                                                    // Have a bad WDR index and also compute a bad address
                                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(bad_wdr_and_bad_addr_cp, !call_stack_underflow&&(operand_b>=32)&&((0<addr)||(addr>=DmemSizeByte)||((addr&32'd31)!=0)))
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(underflow_and_inc_both_and_bad_wdr_cp, call_stack_underflow&&inc_both&&(grx2!=5'd1)&&(operand_b>=32))
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(underflow_and_inc_both_and_bad_addr_cp, call_stack_underflow&&inc_both&&(grs1!=5'd1)&&((0<addr)||(addr>=DmemSizeByte)||((addr&32'd31)!=0)))
                                                                                                                                                                                                                                                                                                    `DEF_MNEM_CROSS(underflow_and_inc_both_and_bad_addr)

                                                                                                                                                                                                                                                                                                    // Set both increments, have a bad WDR index and compute a bad address
                                                                                                                                                                                                                                                                                                    `DEF_SEEN_CP(inc_both_and_bad_wdr_and_bad_addr_cp, inc_both&& !call_stack_underflow&&(operand_b>=32)&&((0<addr)||(addr>=DmemSizeByte)||((addr&32'd31)!=0)))
                                                                                                                                                                                                                                                                                                    `DEF_MNEM_CROSS(inc_both_and_bad_wdr_and_bad_addr)
                                                                                                                                                                                                                                                                                            endgroup

                                                                                                                                                                                                                                                                                                covergroup insn_bn_movr_cg with function sample(logic [31:0] operand_a, logic [31:0] operand_b, logic inc_both, logic [4:0] grs, logic [4:0] grd, logic call_stack_underflow);

                                                                                                                                                                                                                                                                                                        // Underflow call stack and set both increments
                                                                                                                                                                                                                                                                                                        `DEF_SEEN_CP(underflow_and_inc_both_cp, call_stack_underflow&&inc_both)

                                                                                                                                                                                                                                                                                                        // Underflow call stack for grs and have a bad WDR index in *grd.
                                                                                                                                                                                                                                                                                                        `DEF_SEEN_CP(underflow_and_bad_grd_cp, call_stack_underflow&&(grd!=5'd1)&&(operand_b>=32))

                                                                                                                                                                                                                                                                                                        // Underflow call stack for grd and have a bad WDR index in *grs.
                                                                                                                                                                                                                                                                                                        `DEF_SEEN_CP(underflow_and_bad_grs_cp, call_stack_underflow&&(grs!=5'd1)&&(operand_a>=32))

                                                                                                                                                                                                                                                                                                        // Set both increments and have a bad WDR index.
                                                                                                                                                                                                                                                                                                        `DEF_SEEN_CP(inc_both_and_bad_wdr_cp, inc_both&& !call_stack_underflow&&((operand_a>=32)||(operand_b>=32)))

                                                                                                                                                                                                                                                                                                        // Underflow call stack for grs, setting both increments and have a bad WDR index in *grd.
                                                                                                                                                                                                                                                                                                        `DEF_SEEN_CP(underflow_grs_and_inc_both_and_bad_wdr_cp, call_stack_underflow&&inc_both&&(grd!=5'd1)&&(operand_b>=32))

                                                                                                                                                                                                                                                                                                        // Underflow call stack for grd, setting both increments and have a bad WDR index in *grs.
                                                                                                                                                                                                                                                                                                        `DEF_SEEN_CP(underflow_grd_and_inc_both_and_bad_wdr_cp, call_stack_underflow&&inc_both&&(grs!=5'd1)&&(operand_a>=32))
                                                                                                                                                                                                                                                                                                endgroup

                                                                                                                                                                                                                                                                                                    covergroup insn_bn_wsrr_cg with function sample(logic [7:0] wsr_imm, logic has_sideload_key);
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    endgroup
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        function void on_state_change(
                                                                                                                                                                                                                                                                                                            operational_state_e new_state
                                                                                                                                                                                                                                                                                                        );
                                                                                                                                                                                                                                                                                                            last_err_bits = 0;
                                                                                                                                                                                                                                                                                                            last_mnem  = '0;
                                                                                                                                                                                                                                                                                                            // Sample bad internal state related signals here because otherwise they tend to not get
                                                                                                                                                                                                                                                                                                            // captured.
                                                                                                                                                                                                                                                                                                            bad_internal_state_cg.sample(
                                                                                                                                                                                                                                                                                                                                      cfg.trace_vif.urnd_all_zero_q,
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        function void on_write_to_wr_csr(
                                                                                                                                                                                                                                                                                                            uvm_reg csr,
                                                                                                                                                                                                                                                                                                            logic [31:0] data,
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        function void on_ext_csr_access(
                                                                                                                                                                                                                                                                                                            uvm_reg csr,
                                                                                                                                                                                                                                                                                                            otbn_env_pkg::access_e access_type,
                                                                                                                                                                                                                                                                                                            logic [31:0] data,
                                                                                                                                                                                                                                                                                                            operational_state_e state
                                                                                                                                                                                                                                                                                                        );
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            case (csr_name)
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                "err_bits" : begin
                                                                                                                                                                                                                                                                                                                    last_err_bits = data;
                                                                                                                                                                                                                                                                                                                    ext_csr_err_bits_cg.sample(
                                                                                                                                                                                                                                                                                                                                            otbn_pkg::err_bits_t'(data),
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                "fatal_alert_cause" : begin
                                                                                                                                                                                                                                                                                                                    ext_csr_fatal_alert_cause_cg.sample(
                                                                                                                                                                                                                                                                                                                                                     data,
                                                                                                                                                                                                                                                                                                                                                     access_type,
                                                                                                                                                                                                                                                                                                                                                     state
                                                                                                                                                                                                                                                                                                                                                 );
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    if ((state==OperationalStateLocked)&&(access_type==AccessSoftwareRead)&&(data==(1<<7))) begin
                                                                                                                                                                                                                                                                                                                        promoted_err_cg.sample(last_err_bits[5:0]);
                                                                                                                                                                                                                                                                                                                    end
                                                                                                                                                                                                                                                                                                                end
                                                                                                                                                                                                                                                                                                                "insn_cnt" : begin
                                                                                                                                                                                                                                                                                                                    ext_csr_insn_cnt_cg.sample(
                                                                                                                                                                                                                                                                                                                                            data,
                                                                                                                                                                                                                                                                                                                                            csr.get_mirrored_value(),
                                                                                                                                                                                                                                                                                                                                            access_type,
                                                                                                                                                                                                                                                                                                                                            state
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                "load_checksum" : begin
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    case (wur_state)
                                                                                                                                                                                                                                                                                                                        WUR_IDLE: begin
                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                            // take effect.
                                                                                                                                                                                                                                                                                                                            if ((data!=csr.get_mirrored_value())&&(access_type==AccessSoftwareWrite)&&(state==OperationalStateIdle)) begin
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        //
                                                                                                                                                                                                                                                                                                        function void on_insn(
                                                                                                                                                                                                                                                                                                            otbn_model_item iss_item,
                                                                                                                                                                                                                                                                                                            otbn_trace_item rtl_item
                                                                                                                                                                                                                                                                                                        );
                                                                                                                                                                                                                                                                                                            string encoding;
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            call_stack_overflow = ((rtl_item.call_stack_fullness==StackFull)&&call_stack_push&& !call_stack_pop);
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            for (int fg = 0 ; fg<2 ; fg++) begin
                                                                                                                                                                                                                                                                                                                if (rtl_item.flags_write_valid[fg]) begin
                                                                                                                                                                                                                                                                                                                    flag_write_cg.sample(
                                                                                                                                                                                                                                                                                                                                      fg[0],
                                                                                                                                                                                                                                                                                                                                      rtl_item.flags_read_data[fg],
                                                                                                                                                                                                                                                                                                                                      rtl_item.flags_write_data[fg]
                                                                                                                                                                                                                                                                                                                                  );
                                                                                                                                                                                                                                                                                                                end
                                                                                                                                                                                                                                                                                                            end
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            case (encoding)
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                "bnai" : enc_bnai_cg.sample(
                                                                                                                                                                                                                                                                                                                                         mnem,
                                                                                                                                                                                                                                                                                                                                         insn_data,
                                                                                                                                                                                                                                                                                                                                         rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                         rtl_item.flags_write_data
                                                                                                                                                                                                                                                                                                                                     );
                                                                                                                                                                                                                                                                                                                "bnam" : enc_bnam_cg.sample(
                                                                                                                                                                                                                                                                                                                                         mnem,
                                                                                                                                                                                                                                                                                                                                         insn_data,
                                                                                                                                                                                                                                                                                                                                         rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                         rtl_item.wdr_operand_b
                                                                                                                                                                                                                                                                                                                                     );
                                                                                                                                                                                                                                                                                                                "bnan" : enc_bnan_cg.sample(
                                                                                                                                                                                                                                                                                                                                         mnem,
                                                                                                                                                                                                                                                                                                                                         insn_data,
                                                                                                                                                                                                                                                                                                                                         rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                         rtl_item.flags_write_data,
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                "bnaq" : enc_bnaq_cg.sample(
                                                                                                                                                                                                                                                                                                                                         mnem,
                                                                                                                                                                                                                                                                                                                                         insn_data,
                                                                                                                                                                                                                                                                                                                                         rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                         rtl_item.wdr_operand_b
                                                                                                                                                                                                                                                                                                                                     );
                                                                                                                                                                                                                                                                                                                "bnaqs" : enc_bnaqs_cg.sample(
                                                                                                                                                                                                                                                                                                                                           mnem,
                                                                                                                                                                                                                                                                                                                                           insn_data,
                                                                                                                                                                                                                                                                                                                                           rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                           rtl_item.wdr_operand_b,
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                "bnmov" : enc_bnmov_cg.sample(
                                                                                                                                                                                                                                                                                                                                           mnem,
                                                                                                                                                                                                                                                                                                                                           insn_data,
                                                                                                                                                                                                                                                                                                                                           rtl_item.wdr_operand_a
                                                                                                                                                                                                                                                                                                                                       );
                                                                                                                                                                                                                                                                                                                "bnmovr" : enc_bnmovr_cg.sample(
                                                                                                                                                                                                                                                                                                                                             mnem,
                                                                                                                                                                                                                                                                                                                                             insn_data,
                                                                                                                                                                                                                                                                                                                                             rtl_item.gpr_operand_a,
                                                                                                                                                                                                                                                                                                                                             rtl_item.gpr_operand_b
                                                                                                                                                                                                                                                                                                                                         );
                                                                                                                                                                                                                                                                                                                "bnr" : enc_bnr_cg.sample(
                                                                                                                                                                                                                                                                                                                                       mnem,
                                                                                                                                                                                                                                                                                                                                       insn_data,
                                                                                                                                                                                                                                                                                                                                       rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                       rtl_item.wdr_operand_b
                                                                                                                                                                                                                                                                                                                                   );
                                                                                                                                                                                                                                                                                                                "bns" : enc_bns_cg.sample(
                                                                                                                                                                                                                                                                                                                                       mnem,
                                                                                                                                                                                                                                                                                                                                       insn_data,
                                                                                                                                                                                                                                                                                                                                       rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                       rtl_item.wdr_operand_b,
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                "ecall" : enc_ecall_cg.sample(mnem, insn_data);
                                                                                                                                                                                                                                                                                                                "I" : enc_i_cg.sample(
                                                                                                                                                                                                                                                                                                                                   mnem,
                                                                                                                                                                                                                                                                                                                                   insn_data,
                                                                                                                                                                                                                                                                                                                                   rtl_item.gpr_operand_a
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                "bnva" : enc_bnva_cg.sample(
                                                                                                                                                                                                                                                                                                                                         mnem,
                                                                                                                                                                                                                                                                                                                                         insn_data,
                                                                                                                                                                                                                                                                                                                                         rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                         rtl_item.wdr_operand_b
                                                                                                                                                                                                                                                                                                                                     );
                                                                                                                                                                                                                                                                                                                "bnvm" : enc_bnvm_cg.sample(
                                                                                                                                                                                                                                                                                                                                         mnem,
                                                                                                                                                                                                                                                                                                                                         insn_data,
                                                                                                                                                                                                                                                                                                                                         rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                         rtl_item.wdr_operand_b
                                                                                                                                                                                                                                                                                                                                     );
                                                                                                                                                                                                                                                                                                                "bnvtrn" : enc_bnvtrn_cg.sample(
                                                                                                                                                                                                                                                                                                                                             mnem,
                                                                                                                                                                                                                                                                                                                                             insn_data,
                                                                                                                                                                                                                                                                                                                                             rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                             rtl_item.wdr_operand_b
                                                                                                                                                                                                                                                                                                                                         );
                                                                                                                                                                                                                                                                                                                "bnvsh" : enc_bnvsh_cg.sample(
                                                                                                                                                                                                                                                                                                                                           mnem,
                                                                                                                                                                                                                                                                                                                                           insn_data,
                                                                                                                                                                                                                                                                                                                                           rtl_item.wdr_operand_b,
                                                                                                                                                                                                                                                                                                                                           nonzero_shift_results
                                                                                                                                                                                                                                                                                                                                       );
                                                                                                                                                                                                                                                                                                                "bnpk" : enc_bnpk_cg.sample(
                                                                                                                                                                                                                                                                                                                                         mnem,
                                                                                                                                                                                                                                                                                                                                         insn_data,
                                                                                                                                                                                                                                                                                                                                         rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                         rtl_item.wdr_operand_b
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                ;
                                                                                                                                                                                                                                                                                                                default: `dv_fatal($sformatf(
                                                                                                                                                                                                                                                                                                                                       "Unknown encoding (%0s) for instruction `%0s'",
                                                                                                                                                                                                                                                                                                                                       encoding,
                                                                                                                                                                                                                                                                                                                                       mnem
                                                                                                                                                                                                                                                                                                                                   ),
                                                                                                                                                                                                                                                                                                                                   `gfn)
                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                            case (mnem)
                                                                                                                                                                                                                                                                                                                mnem_add, mnem_sub: insn_addsub_cg.sample(
                                                                                                                                                                                                                                                                                                                                                       mnem,
                                                                                                                                                                                                                                                                                                                                                       rtl_item.gpr_operand_a,
                                                                                                                                                                                                                                                                                                                                                       rtl_item.gpr_operand_b
                                                                                                                                                                                                                                                                                                                                                   );
                                                                                                                                                                                                                                                                                                                mnem_addi: insn_addi_cg.sample(insn_data, rtl_item.gpr_operand_a);
                                                                                                                                                                                                                                                                                                                mnem_sll: insn_sll_cg.sample(rtl_item.gpr_operand_a, rtl_item.gpr_operand_b);
                                                                                                                                                                                                                                                                                                                mnem_slli: insn_slli_cg.sample(insn_data, rtl_item.gpr_operand_a);
                                                                                                                                                                                                                                                                                                                mnem_srl: insn_srl_cg.sample(rtl_item.gpr_operand_a, rtl_item.gpr_operand_b);
                                                                                                                                                                                                                                                                                                                mnem_srli: insn_srli_cg.sample(insn_data, rtl_item.gpr_operand_a);
                                                                                                                                                                                                                                                                                                                mnem_sra: insn_sra_cg.sample(rtl_item.gpr_operand_a, rtl_item.gpr_operand_b);
                                                                                                                                                                                                                                                                                                                mnem_srai: insn_srai_cg.sample(insn_data, rtl_item.gpr_operand_a);
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                if (insn_data[11:7]!=0) begin
                                                                                                                                                                                                                                                                                                                    insn_log_binop_cg.sample(
                                                                                                                                                                                                                                                                                                                                          mnem,
                                                                                                                                                                                                                                                                                                                                          insn_data,
                                                                                                                                                                                                                                                                                                                                          rtl_item.gpr_write_data
                                                                                                                                                                                                                                                                                                                                      );
                                                                                                                                                                                                                                                                                                                end
                                                                                                                                                                                                                                                                                                                mnem_lw: begin
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                mnem_csrrs: insn_csrrs_cg.sample(
                                                                                                                                                                                                                                                                                                                                              insn_data,
                                                                                                                                                                                                                                                                                                                                              rtl_item.gpr_operand_a,
                                                                                                                                                                                                                                                                                                                                              rtl_item.call_stack_fullness
                                                                                                                                                                                                                                                                                                                                          );
                                                                                                                                                                                                                                                                                                                mnem_csrrw: insn_csrrw_cg.sample(insn_data, rtl_item.call_stack_fullness);
                                                                                                                                                                                                                                                                                                                mnem_loop: insn_loop_cg.sample(
                                                                                                                                                                                                                                                                                                                                            rtl_item.insn_addr,
                                                                                                                                                                                                                                                                                                                                            insn_data,
                                                                                                                                                                                                                                                                                                                                            rtl_item.gpr_operand_a,
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                mnem_bn_addc: insn_bn_addc_cg.sample(insn_data, rtl_item.flags_read_data);
                                                                                                                                                                                                                                                                                                                mnem_bn_addm: insn_bn_addm_cg.sample(
                                                                                                                                                                                                                                                                                                                                                  insn_data,
                                                                                                                                                                                                                                                                                                                                                  rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                                  rtl_item.wdr_operand_b,
                                                                                                                                                                                                                                                                                                                                                  rtl_item.mod
                                                                                                                                                                                                                                                                                                                                              );
                                                                                                                                                                                                                                                                                                                mnem_bn_mulqacc, mnem_bn_mulqacc_so, mnem_bn_mulqacc_wo: insn_bn_mulqaccx_cg.sample(mnem, rtl_item.new_acc_extended);
                                                                                                                                                                                                                                                                                                                mnem_bn_subb, mnem_bn_cmpb: insn_bn_subcmpb_cg.sample(
                                                                                                                                                                                                                                                                                                                                                                   mnem,
                                                                                                                                                                                                                                                                                                                                                                   insn_data,
                                                                                                                                                                                                                                                                                                                                                                   rtl_item.flags_read_data
                                                                                                                                                                                                                                                                                                                                                               );
                                                                                                                                                                                                                                                                                                                mnem_bn_subm: insn_bn_subm_cg.sample(
                                                                                                                                                                                                                                                                                                                                                  insn_data,
                                                                                                                                                                                                                                                                                                                                                  rtl_item.wdr_operand_a,
                                                                                                                                                                                                                                                                                                                                                  rtl_item.wdr_operand_b,
                                                                                                                                                                                                                                                                                                                                                  rtl_item.mod
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                mnem_bn_lid, mnem_bn_sid: begin
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    local_x1_uflow = (rtl_item.call_stack_fullness==StackEmpty)&&((grs1==5'd1)||(grx2==5'd1));
                                                                                                                                                                                                                                                                                                                    `DV_CHECK_FATAL(local_x1_uflow || !call_stack_underflow)`DV_CHECK_FATAL(inc_both || call_stack_underflow || !local_x1_uflow)

                                                                                                                                                                                                                                                                                                                    insn_bn_xid_cg.sample(
                                                                                                                                                                                                                                                                                                                                       mnem,
                                                                                                                                                                                                                                                                                                                                       imm15,
                                                                                                                                                                                                                                                                                                                                       rtl_item.gpr_operand_a,
                                                                                                                                                                                                                                                                                                                                       rtl_item.gpr_operand_b,
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                mnem_bn_movr: begin
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    // !inc_both. However, when both increments are set the RTL decoder squashes the call stack
                                                                                                                                                                                                                                                                                                                    // update flags so we have to figure them out ourselves.
                                                                                                                                                                                                                                                                                                                    local_x1_uflow = (rtl_item.call_stack_fullness==StackEmpty)&&((grs==5'd1)||(grd==5'd1));
                                                                                                                                                                                                                                                                                                                    `DV_CHECK_FATAL(local_x1_uflow || !call_stack_underflow)`DV_CHECK_FATAL(inc_both || call_stack_underflow || !local_x1_uflow)

                                                                                                                                                                                                                                                                                                                    insn_bn_movr_cg.sample(
                                                                                                                                                                                                                                                                                                                                        rtl_item.gpr_operand_a,
                                                                                                                                                                                                                                                                                                                                        rtl_item.gpr_operand_b,
                                                                                                                                                                                                                                                                                                                                        inc_both,
                                                                                                                                                                                                                                                                                                                                        grs,
