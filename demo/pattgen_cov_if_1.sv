...
covergroup ctrl_cg @(posedge clk_i);
    ...
    cross_contr: cross cp_enable_ch0, cp_enable_ch1, cp_polarity_ch0, cp_polarity_ch1;
endgroup: ctrl_cg
...
covergroup pattgen_ch0_cnt_reset_cg @(posedge clk_i);
    ...
    cp_reps_trans_ch0: coverpoint {
        ch0_cnt_match_reps, ch0_cnt_reset_reps, rep_cnt_en_ch0
    }
    {bins trans2Zero_reps = (3'b100 => 3'b101 => 3'b010);
        bins others = default;
    }
    cp_reps_reset_trans_ch0: coverpoint {
        ch0_cnt_match_reps, ch0_cnt_reset_reps
    }
    {bins trans2Zero_reps = (2'b10 => 2'b01);
        bins others = default;
    }
    cp_len_reset_trans_ch0: coverpoint {
        ch0_cnt_match_len, ch0_cnt_len_reset
    }
    {bins trans2Zero_len = (2'b10 => 2'b01);
        bins others = default;
    }
    cp_prediv_reset_trans_ch0: coverpoint {
        ch0_cnt_match_prediv, ch0_cnt_reset
    }
    {bins trans2Zero_prediv = (2'b10 => 2'b01);
        bins others = default;
    }
    cp_cross_reps_len_prediv: cross cp_reps_reset_trans_ch0, cp_len_reset_trans_ch0;
    cp_match_reps_tr_ch0: coverpoint {
        ch0_cnt_match_reps
    }
    {bins zero2one = (1'b0 => 1'b1);
        bins one2zero = (1'b1 => 1'b0);
    }
    cp_reset_reps_tr_ch0: coverpoint {
        ch0_cnt_reset_reps
    }
    {bins zero2one = (1'b0 => 1'b1);
        bins one2zero = (1'b1 => 1'b0);
    }
    cp_rep_cnt_en_tr_ch0: coverpoint {
        rep_cnt_en_ch0
    }
    {bins zero2one = (1'b0 => 1'b1);
        bins one2zero = (1'b1 => 1'b0);
...
covergroup pattgen_ch1_cnt_reset_cg @(posedge clk_i);
    ...
    option.comment = "Counters reset after match";
    cp_reps_trans_ch1: coverpoint {
        ch1_cnt_match_reps, ch1_cnt_reset_reps, rep_cnt_en_ch1
    }
    {bins trans2Zero_reps = (3'b100 => 3'b101 => 3'b010);
        bins others = default;
    }
    cp_reps_reset_trans_ch1: coverpoint {
        ch1_cnt_match_reps, ch1_cnt_reset_reps
    }
    {bins trans2Zero_reps = (2'b10 => 2'b01);
        bins others = default;
    }
    cp_len_reset_trans_ch1: coverpoint {
        ch1_cnt_match_len, ch1_cnt_len_reset
    }
    {bins trans2Zero_len = (2'b10 => 2'b01);
        bins others = default;
    }
    cp_prediv_reset_trans_ch1: coverpoint {
        ch1_cnt_match_prediv, ch1_cnt_reset
    }
    {bins trans2Zero_prediv = (2'b10 => 2'b01);
        bins others = default;
    }
    cp_cross_reps_len_prediv_ch1: cross cp_reps_reset_trans_ch1, cp_len_reset_trans_ch1;
    cp_match_reps_tr_ch1: coverpoint {
        ch1_cnt_match_reps
    }
    {bins zero2one = (1'b0 => 1'b1);
        bins one2zero = (1'b1 => 1'b0);
    }
    cp_reset_reps_tr_ch1: coverpoint {
        ch1_cnt_reset_reps
    }
    {bins zero2one = (1'b0 => 1'b1);
        bins one2zero = (1'b1 => 1'b0);
    }
    cp_rep_cnt_en_tr_ch1: coverpoint {
        rep_cnt_en_ch1
    }
    {bins zero2one = (1'b0 => 1'b1);
        bins one2zero = (1'b1 => 1'b0);
...
covergroup inter_cg @(posedge clk_i);
    ...
    cp_intr_enab_ch0: coverpoint u_pattgen_core.reg2hw.intr_enable.done_ch0.q;
    cp_intr_state_ch0: coverpoint u_pattgen_core.reg2hw.intr_state.done_ch0.q;
    cp_intr_test_ch0: coverpoint u_pattgen_core.reg2hw.intr_test.done_ch0.q;
...
covergroup pattgen_data_ch0_0_cg @(posedge clk_i);
    ...
    cp_data_ch00: coverpoint {
        tb.dut.u_pattgen_core.ch0_ctrl.data[31:0]
    }
    {bins maxim = {DataMax};
...
covergroup pattgen_data_ch0_1_cg @(posedge clk_i);
    ...
    cp_data_ch01: coverpoint {
        tb.dut.u_pattgen_core.ch0_ctrl.data[63:32]
    }
    {bins maxim = {DataMax};
        bins mid[NO_DATA_BINS] = {[DataMin+1:DataMax-1]};
        bins minim = {DataMin};
...
covergroup pattgen_data_ch1_0_cg @(posedge clk_i);
    ...
    cp_data_ch10: coverpoint {
        tb.dut.u_pattgen_core.ch1_ctrl.data[31:0]
    }
    {bins maxim = {DataMax};
        bins mid[NO_DATA_BINS] = {[DataMin+1:DataMax-1]};
        bins minim = {DataMin};
...
covergroup pattgen_data_ch1_1_cg @(posedge clk_i);
    ...
    cp_data_ch11: coverpoint {
        tb.dut.u_pattgen_core.ch1_ctrl.data[63:32]
    }
    {bins maxim = {DataMax};
        bins mid[NO_DATA_BINS] = {[DataMin+1:DataMax-1]};
        bins minim = {DataMin};
...
covergroup roll_cg @(posedge clk_i);
    ...
    cp_len_cnt_ch0: coverpoint {
        len_q0
    }
    {bins maxim_0 = {'h3 f};
        bins mid_range_0[NO_LEN_BINS] = {[1:'h3 e]};
        bins minim_0 = {0};
    }
    cp_len_cnt_ch1: coverpoint {
        len_q1
    }
    {bins maxim_1 = {'h3 f};
        bins mid_range_1[NO_LEN_BINS] = {[1:'h3 e]};
        bins minim_1 = {0};
    }
    cp_reps_cnt_ch0: coverpoint {
        reps_q0
    }
    {bins maxim_0 = {'h3 ff};
        bins mid_range_0[NO_REPS_BINS] = {[1:'h3 fe]};
        bins minim_0 = {0};
    }
    cp_reps_cnt_ch1: coverpoint {
        reps_q1
    }
    {bins maxim_1 = {'h3 ff};
        bins mid_range_1[NO_REPS_BINS] = {[1:'h3 fe]};
        bins minim_1 = {0};
    }
